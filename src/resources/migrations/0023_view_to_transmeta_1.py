...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'View.name_en'
        db.add_column('resources_view', 'name_en', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)

        # Adding field 'View.name_de'
        db.add_column('resources_view', 'name_de', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'View.name_en'
        db.delete_column('resources_view', 'name_en')

        # Deleting field 'View.name_de'
        db.delete_column('resources_view', 'name_de')
    ...
    models = {
        ...
        'resources.resource': {
            ...
            'template': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['resources.ResourceTemplate']", 'null': 'True', 'blank': 'True'})
        },

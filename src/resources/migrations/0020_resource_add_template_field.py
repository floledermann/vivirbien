...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('resources_resource', 'template', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['resources.ResourceTemplate'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Resource.template'
        db.delete_column('resources_resource', 'template_id')

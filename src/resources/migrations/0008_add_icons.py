...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Icon'
        db.create_table('resources_icon', (
            ('id', orm['resources.icon:id']),
            ('name', orm['resources.icon:name']),
            ('image', orm['resources.icon:image']),
        ))
        db.send_create_signal('resources', ['Icon'])
        
        # Adding field 'TagMapping.subicon'
        db.add_column('resources_tagmapping', 'subicon', orm['resources.tagmapping:subicon'])

        db.delete_column('resources_tagmapping', 'icon')
            
        db.add_column('resources_tagmapping', 'icon', orm['resources.tagmapping:icon'])

    def backwards(self, orm):
        
        # Deleting model 'Icon'
        db.delete_table('resources_icon')
        
        # Deleting field 'TagMapping.subicon'
        db.delete_column('resources_tagmapping', 'subicon')

        db.delete_column('resources_tagmapping', 'icon_id_id')
    ...
    models = {
        ...
        'resources.tagmapping': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True'}),
            'icon': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['resources.Icon']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'max_length': '100', 'db_index': 'True'}),

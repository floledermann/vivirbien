...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'View.show_map'
        # attention: in south 0.7 this fails to set the correct default in SQLite, see http://south.aeracode.org/ticket/600
        db.add_column('resources_view', 'show_map', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'View.show_map'
        db.delete_column('resources_view', 'show_map')

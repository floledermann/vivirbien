...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TagTemplate.creator'
        db.alter_column('resources_tagtemplate', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True))

        # Changing field 'TagTemplateGroup.creator'
        db.alter_column('resources_tagtemplategroup', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True))

        # Adding field 'Tag.value_date'
        db.add_column('resources_tag', 'value_date', self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True), keep_default=False)

        # Adding field 'Tag.value_relation'
        db.add_column('resources_tag', 'value_relation', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='relations_to', null=True, to=orm['resources.Resource']), keep_default=False)

        # Changing field 'ResourceTemplate.creator'
        db.alter_column('resources_resourcetemplate', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'TagTemplate.creator'
        db.alter_column('resources_tagtemplate', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'TagTemplateGroup.creator'
        db.alter_column('resources_tagtemplategroup', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Deleting field 'Tag.value_date'
        db.delete_column('resources_tag', 'value_date')

        # Deleting field 'Tag.value_relation'
        db.delete_column('resources_tag', 'value_relation_id')

        # Changing field 'ResourceTemplate.creator'
        db.alter_column('resources_resourcetemplate', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
    ...
    models = {
        ...
        'resources.tag': {
            ...
            'value_relation': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'relations_to'", 'null': 'True', 'to': "orm['resources.Resource']"})
        },
        ...
        'resources.tagtemplate': {
            'Meta': {'object_name': 'TagTemplate'},
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tags'", 'to': "orm['resources.TagTemplateGroup']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'name_en': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'order': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'template': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tags'", 'to': "orm['resources.ResourceTemplate']"}),
            'value': ('django.db.models.fields.TextField', [], {'blank': 'True'})
        },
        'resources.tagtemplategroup': {
            ...
            'name_en': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'order': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'template': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'groups'", 'to': "orm['resources.ResourceTemplate']"})
        },

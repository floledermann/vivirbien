...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('resources_tagtemplate', (
            ...
            ('template', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tags', to=orm['resources.ResourceTemplate'])),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tags', to=orm['resources.TagTemplateGroup'])),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('resources', ['TagTemplate'])

        # Adding model 'TagTemplateGroup'
        db.create_table('resources_tagtemplategroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name_en', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('name_de', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('template', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tag_groups', to=orm['resources.ResourceTemplate'])),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('resources', ['TagTemplateGroup'])

        # Adding model 'ResourceTemplate'
        db.create_table('resources_resourcetemplate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name_en', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('name_de', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ...
        db.send_create_signal('resources', ['ResourceTemplate'])


    def backwards(self, orm):
        
        # Deleting model 'TagTemplate'
        db.delete_table('resources_tagtemplate')

        # Deleting model 'TagTemplateGroup'
        db.delete_table('resources_tagtemplategroup')

        # Deleting model 'ResourceTemplate'
        db.delete_table('resources_resourcetemplate')
    ...
    models = {
        ...
        'resources.tagtemplategroup': {
            ...
            'name_en': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'order': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'template': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tag_groups'", 'to': "orm['resources.ResourceTemplate']"})
        },

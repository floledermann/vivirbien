...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Resource.start_date'
        db.add_column('resources_resource', 'start_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Resource.end_date'
        db.add_column('resources_resource', 'end_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'View.include_past'
        db.add_column('resources_view', 'include_past', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'View.include_current'
        db.add_column('resources_view', 'include_current', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)

        # Adding field 'View.include_upcoming'
        db.add_column('resources_view', 'include_upcoming', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Resource.start_date'
        db.delete_column('resources_resource', 'start_date')

        # Deleting field 'Resource.end_date'
        db.delete_column('resources_resource', 'end_date')

        # Deleting field 'View.include_past'
        db.delete_column('resources_view', 'include_past')

        # Deleting field 'View.include_current'
        db.delete_column('resources_view', 'include_current')

        # Deleting field 'View.include_upcoming'
        db.delete_column('resources_view', 'include_upcoming')

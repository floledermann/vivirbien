...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('resources_resource', 'shortname', self.gf('django.db.models.fields.SlugField')(max_length=200, unique=True))

        # Adding unique constraint on 'Icon', fields ['name']
        db.create_unique('resources_icon', ['name'])


    def backwards(self, orm):
        
        # Changing field 'Resource.shortname'
        db.alter_column('resources_resource', 'shortname', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=100))

        # Removing unique constraint on 'Icon', fields ['name']
        db.delete_unique('resources_icon', ['name'])
    ...
    models = {
        ...
        'resources.resource': {
            ...
            'shortname': ('django.db.models.fields.SlugField', [], {'max_length': '200', 'unique': 'True', 'db_index': 'True'})
        },
        'resources.tag': {
        ...
        'resources.view': {
            ...
            'sub_views': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'parent_views'", 'blank': 'True', 'null': 'True', 'to': "orm['resources.View']"})
        }
    }

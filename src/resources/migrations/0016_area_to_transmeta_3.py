...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Area.name'
        db.delete_column('resources_area', 'name')


    def backwards(self, orm):
        
        # Adding field 'Area.name'
        db.add_column('resources_area', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)

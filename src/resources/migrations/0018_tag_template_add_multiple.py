...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TagTemplate.multiple'
        db.add_column('resources_tagtemplate', 'multiple', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TagTemplate.multiple'
        db.delete_column('resources_tagtemplate', 'multiple')

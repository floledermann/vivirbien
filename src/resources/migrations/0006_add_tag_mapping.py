...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('resources_tagmapping', (
            ('id', orm['resources.tagmapping:id']),
            ('key', orm['resources.tagmapping:key']),
            ('value', orm['resources.tagmapping:value']),
            ('show_in_list', orm['resources.tagmapping:show_in_list']),
            ('icon', orm['resources.tagmapping:icon']),
            ('order', orm['resources.tagmapping:order']),
            ('creator', orm['resources.tagmapping:creator']),
            ('creation_date', orm['resources.tagmapping:creation_date']),
            ('view', orm['resources.tagmapping:view']),
        ))
        db.send_create_signal('resources', ['TagMapping'])
        
        # Changing field 'Tag.value'
        # (to signature: django.db.models.fields.TextField(db_index=True))
        db.alter_column('resources_tag', 'value', orm['resources.tag:value'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('resources_tagmapping')

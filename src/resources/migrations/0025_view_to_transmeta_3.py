...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'View.name'
        db.delete_column('resources_view', 'name')


    def backwards(self, orm):
        
        # Adding field 'View.name'
        db.add_column('resources_view', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)

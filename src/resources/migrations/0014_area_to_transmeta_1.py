...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Area.name_en'
        db.add_column('resources_area', 'name_en', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)

        # Adding field 'Area.name_de'
        db.add_column('resources_area', 'name_de', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Area.name_en'
        db.delete_column('resources_area', 'name_en')

        # Deleting field 'Area.name_de'
        db.delete_column('resources_area', 'name_de')

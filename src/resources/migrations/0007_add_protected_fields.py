...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Resource.protected'
        db.add_column('resources_resource', 'protected', orm['resources.resource:protected'])
        
        # Adding field 'View.protected'
        db.add_column('resources_view', 'protected', orm['resources.view:protected'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Resource.protected'
        db.delete_column('resources_resource', 'protected')
        
        # Deleting field 'View.protected'
        db.delete_column('resources_view', 'protected')
    ...
    models = {
        ...
        'resources.tagmapping': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True'}),
            'icon': ('django.db.models.fields.CharField', [], {'default': "'default'", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'max_length': '100', 'db_index': 'True'}),

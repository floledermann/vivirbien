...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TagQuery.creator'
        db.add_column('resources_tagquery', 'creator', orm['resources.tagquery:creator'])
        
        # Adding field 'TagQuery.creation_date'
        db.add_column('resources_tagquery', 'creation_date', orm['resources.tagquery:creation_date'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'TagQuery.creator'
        db.delete_column('resources_tagquery', 'creator_id')
        
        # Deleting field 'TagQuery.creation_date'
        db.delete_column('resources_tagquery', 'creation_date')
